...
public class UGUI : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        //PITCH.text = this.mytransform.localEulerAngles.x < 180? 
        //    "Pitch: " + this.mytransform.localEulerAngles.x.ToString("0.000"): "Pitch: " + (this.mytransform.localEulerAngles.x - 360).ToString("0.000");
        //YAW.text = this.mytransform.localEulerAngles.y+60 < 180 ?
        //    "Yaw: " + (this.mytransform.localEulerAngles.y + 60).ToString("0.000") : "Yaw: " + (this.mytransform.localEulerAngles.y - 300).ToString("0.000");
        //ROLL.text = this.mytransform.localEulerAngles.z < 180 ?
        //    "Roll: " + this.mytransform.localEulerAngles.z.ToString("0.000") : "Roll: " + (this.mytransform.localEulerAngles.z - 360).ToString("0.000");
