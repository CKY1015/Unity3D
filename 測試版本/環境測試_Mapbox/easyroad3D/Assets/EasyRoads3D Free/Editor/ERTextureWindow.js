...
var dir : DirectoryInfo= new DirectoryInfo(Directory.GetCurrentDirectory() + OCDOQDQQDQ.extensionPath + "Textures/Road Textures/");

assetPath = OCDOQDQQDQ.extensionPath.Substring(1, OCDOQDQQDQ.extensionPath.Length - 1);
...
var road : GameObject = roadscript.OQDDQQDOOD.road;
if(road != null){
