...
namespace Wrld.Resources.IndoorMaps
{
    internal class IndoorMapsApiInternal
    {
        ...
        public delegate void IndoorMapEntityClickHandler(IntPtr internalApiHandle, [MarshalAs(UnmanagedType.LPStr)] string entityIds);
        ...
        [MonoPInvokeCallback(typeof(IndoorMapEntityClickHandler))]
        public static void OnIndoorMapEntityClickedCallback(IntPtr internalApiHandle, [MarshalAs(UnmanagedType.LPStr)] string entityIds)
        {
            var indoorMapsApiInternal = internalApiHandle.NativeHandleToObject<IndoorMapsApiInternal>();

            if (entityIds != null && entityIds.Length > 0)
            {
                indoorMapsApiInternal.OnIndoorMapEntityClickedInternal(entityIds);
            }
        }
