...
namespace Wrld
{
    ...
    internal struct IndoorMapCallbacks
    {
        private IndoorMapCallbacks(
            ...
            IndoorMapsApiInternal.IndoorMapEntityClickHandler _onIndoorMapEntityClickedCallback,
            ...
            IndoorMapMaterialService.DeleteMaterialCallback _deleteMaterial)
        {
            ...
            onIndoorMapEntityClickedCallback = _onIndoorMapEntityClickedCallback;
        ...
        public static IndoorMapCallbacks Create(IntPtr _indoorMapsApiHandle, IntPtr _indoorMapsMaterialServiceHandle, IntPtr _indoorMapsSceneHandle)
        {
            return new IndoorMapCallbacks(
                ...
                IndoorMapsApiInternal.OnIndoorMapEntityClickedCallback,
        ...
        IndoorMapsApiInternal.IndoorMapEntityClickHandler onIndoorMapEntityClickedCallback;
