...
public class HighlightingIndoors : MonoBehaviour
{
	...
	{
		Api.Instance.IndoorMapsApi.SetIndoorEntityHighlight("Small Meeting Room", m_smallRoomColor);
		Api.Instance.IndoorMapsApi.SetIndoorEntityHighlight("Meeting Room", m_meetingRoomColor);
	...
	{
        Api.Instance.IndoorMapsApi.ClearIndoorEntityHighlights(new[] { "0007", "0002", "0033", "Small Meeting Room", "Meeting Room" });
    }
